...
int primary()
{
    ...
    // 着色器类
    Shader lightingShader("02lighting/5.1.light_casters.vs", "02lighting/5.1.light_casters.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // imgui 界面
        {
            ...
            if (ImGui::CollapsingHeader("投光物"))
            {
                ...
                if (ImGui::Combo("投光物类型", &imgui_combo_item, items, IM_ARRAYSIZE(items)))
                {
                    switch (imgui_combo_item)
                    {
                    case 0:
                        lightingShader = Shader("02lighting/5.1.light_casters.vs", "02lighting/5.1.light_casters.fs");
                        break;
                    case 1:
                        lightingShader = Shader("02lighting/5.1.light_casters.vs", "02lighting/5.2.light_casters.fs");
                        break;
                    case 2:
                        lightingShader = Shader("02lighting/5.1.light_casters.vs", "02lighting/5.3.light_casters.fs");
                        break;
                    case 3:
                        lightingShader = Shader("02lighting/5.1.light_casters.vs", "02lighting/5.4.light_casters.fs");
                        break;
                    default:
                        break;
                    }
